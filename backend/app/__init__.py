...
def create_app(config_class=DevConfig):
    ...
    app.register_blueprint(gdoc_html_cleaner_bp, url_prefix="/api/gdoc_html_cleaner")
    app.register_blueprint(hover_translation_bp, url_prefix="/api/hover_translation")
