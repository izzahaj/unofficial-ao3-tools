...
const GoogleDocsHtmlCleanerPage = () => {
  ...
  return (
    ...
    <Stack rowGap={2} direction="column" sx={{ width: '100%', p: 0, m: 0 }}>
      ...
      <Stack>
        ...
        <TabPanel value={value} index={0} sx={{ p: 2, display: 'flex', flexDirection: 'column' }}>
          <Stack rowGap={1} sx={{ flex: 1, minHeight: "75vh" }}>
            <Stack direction={{ xs: "column", sm: "row" }} justifyContent="space-between">
              <Typography variant="h6" fontWeight="bold" alignSelf="flex-start">Type or paste HTML into the editor</Typography>
        ...
        <TabPanel value={value} index={1} sx={{ p: 2, display: 'flex', flexDirection: 'column' }}>
          <Stack rowGap={1} sx={{ flex: 1 }}>
            <Typography variant="h6" fontWeight="bold" alignSelf="flex-start">Upload a HTML file exported from Google Docs</Typography>
            <Stack columnGap={1} direction="row" sx={{ alignItems: "center" }}>
              ...
              <Box flex={1} textOverflow="ellipsis" overflow="hidden" whiteSpace="nowrap" >{uploadedFile?.name || "No file chosen"}</Box>
            </Stack>
          </Stack>
        </TabPanel>
      </Stack>
      ...
      <Stack rowGap={1}>
      <Typography variant="h5" fontWeight="bold" gutterBottom>What does this tool do?</Typography>
      <Typography variant="h6" gutterBottom><strong>Google Docs → AO3, minus the mess</strong></Typography>
      <Typography component="p" >
        When you paste content from Google Docs into AO3’s Rich Text Editor, you might notice weird extra
        spacing, especially around italicised text. That’s because Google Docs wraps styled text in
        complex <code>&lt;span&gt;</code> tags and inline styles that don’t play well with AO3.
      </Typography>
      <Typography component="p">
        This tool cleans up the HTML exported from Google Docs and transforms it into a simplified, AO3-friendly version.
      </Typography>
      <Typography component="p">
      ...
      <List dense sx={{ listStyleType: 'disc', pl: 4 }}>
        <ListItem sx={{ display: 'list-item' }}>
          Preserves basic inline formatting: <strong>bold</strong>, <em>italics</em>, <u>underline</u>, and <s>strikethrough</s>, converting them into their semantic HTML tags (<code>&lt;strong&gt;</code>, <code>&lt;em&gt;</code>, etc.)
        </ListItem>
        <ListItem sx={{ display: 'list-item' }}>
      ...
      <Typography component="p" color="error">
        <strong>Do not paste HTML from other sources</strong> as the structure will be different and might not clean
        correctly.
      </Typography>
      <Typography component="p">
