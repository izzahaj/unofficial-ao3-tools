  ...
  return (
    <Stack rowGap={1}>
      ...
      <List dense sx={{ listStyleType: "disc", pl: 4 }}>
        ...
        <ListItem sx={{ display: "list-item" }}>
          Other formatting (e.g. lists, headings, images, indentation, etc.) is
          not supported
        </ListItem>
      </List>
      ...
      <Typography component="p">
        This tool is built <strong>specifically</strong> for HTML exported from
        Google Docs.
      </Typography>
      <Typography component="p" color="error">
        <strong>Do not paste HTML from other sources</strong> as the structure
        will be different and might not clean correctly.
      </Typography>
      <Typography component="p">
        To export your HTML from Google Docs:
      </Typography>
      <List dense sx={{ listStyleType: "decimal", pl: 4 }}>
        <ListItem sx={{ display: "list-item" }}>Go to your Google Doc</ListItem>
        <ListItem sx={{ display: "list-item" }}>
